...
export const envSchema = Joi.object({
  ...
  APP_ID: Joi.string().required().messages({
    "string.min": "APP_ID must be at least 32 characters",
    "any.required": "APP_ID is required",
  }),
  REST_API_KEY: Joi.string().required().messages({
    "string.min": "REST_API_KEY must be at least 32 characters",
    "any.required": "REST_API_KEY is required",
  }),
