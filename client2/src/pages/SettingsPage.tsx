          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-xl border shadow-sm">
              ...
              <Switch
                ...
                onCheckedChange={(val) => updateSetting("addNotes", val)}
              />
            </div>

            <div className="flex items-center justify-between p-4 rounded-xl border shadow-sm">
              <Label htmlFor="add-purpose">Enable Purpose Field</Label>
              <Switch
                id="add-purpose"
                checked={settings.addPurpose}
                onCheckedChange={(val) => updateSetting("addPurpose", val)}
              />
            </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl border shadow-sm">
              ...
              <Switch
                ...
                onCheckedChange={(val) => updateSetting("addPersonCnic", val)}
              />
            </div>
            <div className="flex items-center justify-between p-4 rounded-xl border shadow-sm">
              <Label htmlFor="add-contact">Enable Contact Field</Label>
              <Switch
                id="add-contact"
