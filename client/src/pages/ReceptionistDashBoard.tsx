          ...
          <Suspense fallback={<Loader />}>
            ...
            >
              <TabsList className="mx-auto mb-2">
                ...
                <TabsTrigger value="schedule">Schedule Meetings</TabsTrigger>
              </TabsList>
              <TabsContent value="requests">
                <RequestMeetings setTabValue={setTabValue} userId={user?.id} />
              </TabsContent>
              <TabsContent value="schedule">
                <ScheduleMeetings setTabValue={setTabValue} userId={user?.id} />
              </TabsContent>
            </Tabs>
          </Suspense>
        </div>
